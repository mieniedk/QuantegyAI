...
const Home = () => {
  ...
  const featuredExams = [
    ...
    { to: '/texes-prep?exam=calculus', label: 'Calculus 1', desc: 'Limits, derivatives, integrals, series, and L\'Hospital\'s Rule.', gradient: 'linear-gradient(135deg, #d97706, #b45309)', border: '#fbbf24' },
  ];
