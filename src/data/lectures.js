...
const LECTURES = {
  ...
  'c008': {
    ...
    keyIdea: 'Exponential: f(x) = a·b^x (initial value a, base b). Transforms: y = a·b^(x−h) + k shifts h horizontally and k vertically, scales by |a|; horizontal asymptote y = k. Logarithm is the inverse: log_b(y) = x ⟺ b^x = y (with b > 0, b ≠ 1). Log graphs: y = a·log_b(x−h) + k has vertical asymptote x = h, domain x > h.',
    steps: [
