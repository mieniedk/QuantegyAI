...
export const TEXES_QUESTIONS = [
  ...
  { id: 'tc11', comp: 'comp001', type: 'mc', difficulty: 2,
    ...
    choices: ['Translation right 3, up 2', 'Rotation by 90°', 'Reflection about the real axis', 'Dilation by factor 3'], answer: 'Translation right 3, up 2',
  ...
  { id: 't074', comp: 'comp002', type: 'mc', difficulty: 2,
    q: 'The graph of y = x² is reflected about the x-axis, shifted right 3 units, and up 2 units. What is the new equation?',
  ...
  { id: 't026', comp: 'comp003', type: 'mc', difficulty: 3,
    ...
    choices: ['Reflection about the x-axis', 'Reflection about the y-axis', 'Rotation 90°', 'Translation'], answer: 'Reflection about the y-axis',
    explanation: 'Reflecting about the y-axis negates the x-coordinate: (x, y) → (−x, y).' },
  ...
  { id: 'tp05', comp: 'comp002', type: 'mc', difficulty: 2,
    ...
    choices: ['1000(1.05)^(n)', '1000 + 50n', '1000(0.95)^(n)', '1050n'], answer: '1000(1.05)^(n)',
    explanation: 'Compound interest: A = P(1 + r)^(n) = 1000(1.05)^(n).' },
  ...
  { id: 'te07', comp: 'comp002', type: 'mc', difficulty: 1,
    q: 'What is the y-intercept of f(x) = 5·2^(x)?',
  ...
  { id: 'te08', comp: 'comp002', type: 'mc', difficulty: 2,
    ...
    explanation: 'log_3(x(x−2)) = 1 → 3^(1) = x(x−2) → x² − 2x = 3 → x² − 2x − 3 = 0 → (x−3)(x+1) = 0. Since x must be positive, x = 3.' },
  ...
  { id: 'tr06', comp: 'comp002', type: 'mc', difficulty: 3,
    ...
    choices: ['(-2, 1)', '(-∞, -2) ∪ (1, ∞)', '(-∞, 1)', '(-2, ∞)'], answer: '(-2, 1)',
...
export const TEXES_QUESTIONS_PHYSICS_MATH_612 = [
  ...
  { id: 'pm020', comp: 'comp_physmath_3', type: 'mc', difficulty: 2, q: 'Which transformation maps (x, y) to (−x, y)?', choices: ['Reflection about the x-axis', 'Reflection about the y-axis', 'Rotation 90°', 'Translation'], answer: 'Reflection about the y-axis', explanation: 'Reflecting about the y-axis negates the x-coordinate.' },
